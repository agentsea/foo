...
def QwenVLServer(
    ...
    image: str = "public.ecr.aws/d8i6n0n1/orign/unsloth-server:825d581",  # "public.ecr.aws/d8i6n0n1/orign/unsloth-server:8b0ee04",  # "us-docker.pkg.dev/agentsea-dev/orign/unsloth-infer:latest"
